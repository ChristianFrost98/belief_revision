...
def convert_to_cnf(belief_base):
    
    new_belief_base = BeliefBase([])
    
    for (belief,priority) in belief_base.belief_base:
        #belief = b[0]
        #priority = b[1]
        ...
        belief = sympy.sympify(belief)
            
        new_belief_base.add_formula(belief, priority)
...
def test():
    ...
    belief_base.add_formula('P & Q', 3)    # Priority 3
